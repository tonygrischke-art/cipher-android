 ...
 *   com.aetheria.cipher.STATE_CHANGE with extra "state" = IDLE|LISTENING|THINKING|SPEAKING
 */
class VoicePipeline(private val context: Context) {
    ...
    companion object {
        ...
        const val ACTION_STATE_CHANGE = "com.aetheria.cipher.VOICE_STATE_CHANGE"
